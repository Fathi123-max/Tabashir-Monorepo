...
class _PaymentApiService implements PaymentApiService {
  ...
  Future<HttpResponse<CheckoutSessionResponse>> createCheckoutSession(
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<HttpResponse<CheckoutSessionResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<HttpResponse<LatestPaymentResponse>> getLatestPayment() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<LatestPaymentResponse>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LatestPaymentResponse _value;
    try {
      _value = LatestPaymentResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
