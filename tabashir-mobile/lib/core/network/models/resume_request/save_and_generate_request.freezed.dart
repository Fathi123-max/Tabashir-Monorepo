...
mixin _$SaveAndGenerateRequest {
 ...
 ResumeData get resumeData; String? get templateId; String? get filename;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SaveAndGenerateRequest&&(identical(other.resumeData, resumeData) || other.resumeData == resumeData)&&(identical(other.templateId, templateId) || other.templateId == templateId)&&(identical(other.filename, filename) || other.filename == filename));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,resumeData,templateId,filename);

@override
String toString() {
  return 'SaveAndGenerateRequest(resumeData: $resumeData, templateId: $templateId, filename: $filename)';
}
...
@useResult
$Res call({
 ResumeData resumeData, String? templateId, String? filename
});
...
/// Create a copy of SaveAndGenerateRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? resumeData = null,Object? templateId = freezed,Object? filename = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ResumeData resumeData,  String? templateId,  String? filename)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SaveAndGenerateRequest() when $default != null:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ResumeData resumeData,  String? templateId,  String? filename)?  $default,) {final _that = this;
switch (_that) {
case _SaveAndGenerateRequest() when $default != null:
return $default(_that.resumeData,_that.templateId,_that.filename);case _:
  return null;
...
class _SaveAndGenerateRequest implements SaveAndGenerateRequest {
  const _SaveAndGenerateRequest({required this.resumeData, this.templateId, this.filename});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SaveAndGenerateRequest&&(identical(other.resumeData, resumeData) || other.resumeData == resumeData)&&(identical(other.templateId, templateId) || other.templateId == templateId)&&(identical(other.filename, filename) || other.filename == filename));
}
...
/// Create a copy of SaveAndGenerateRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? resumeData = null,Object? templateId = freezed,Object? filename = freezed,}) {
