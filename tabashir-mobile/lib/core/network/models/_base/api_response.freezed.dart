...
mixin _$ApiResponse<T> {
 ...
 bool get success; String? get message;@JsonKey(includeToJson: false, includeFromJson: false) T? get data;
...
@useResult
$Res call({
 bool success, String? message,@JsonKey(includeToJson: false, includeFromJson: false) T? data
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool success,  String? message, @JsonKey(includeToJson: false, includeFromJson: false)  T? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool success,  String? message, @JsonKey(includeToJson: false, includeFromJson: false)  T? data)  $default,) {final _that = this;
switch (_that) {
case _ApiResponse():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool success,  String? message, @JsonKey(includeToJson: false, includeFromJson: false)  T? data)?  $default,) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
return $default(_that.success,_that.message,_that.data);case _:
  return null;
...
class _ApiResponse<T> implements ApiResponse<T> {
  const _ApiResponse({required this.success, this.message, @JsonKey(includeToJson: false, includeFromJson: false) this.data});
  factory _ApiResponse.fromJson(Map<String, dynamic> json) => _$ApiResponseFromJson(json);

@override final  bool success;
@override final  String? message;
@override@JsonKey(includeToJson: false, includeFromJson: false) final  T? data;
...
@override
Map<String, dynamic> toJson() {
  return _$ApiResponseToJson<T>(this, );
}
