...
@JsonKey(name: 'gender') String? get gender;/// Match percentage for the job
...
@useResult
$Res call({
@JsonKey(name: 'id') int? jobId,@JsonKey(name: 'job_title') String? jobTitle,@JsonKey(name: 'entity') String? companyName,@JsonKey(name: 'job_description') String? jobDescription,@JsonKey(name: 'vacancy_city') String? location,@JsonKey(name: 'salary') String? salary,@JsonKey(name: 'job_type') String? jobType,@JsonKey(name: 'apply_url') String? applyUrl,@JsonKey(name: 'academic_qualification') String? academicQualification,@JsonKey(name: 'experience') String? experience,@JsonKey(name: 'languages') String? languages,@JsonKey(name: 'working_hours') String? workingHours,@JsonKey(name: 'working_days') String? workingDays,@JsonKey(name: 'application_email') String? applicationEmail,@JsonKey(name: 'job_date') String? jobDate,@JsonKey(name: 'phone') String? phone,@JsonKey(name: 'source') String? source,@JsonKey(name: 'nationality') String? nationality,@JsonKey(name: 'gender') String? gender,@JsonKey(name: 'match_percentage') String? matchPercentage
});
...
as String?,matchPercentage: freezed == matchPercentage ? _self.matchPercentage : matchPercentage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
switch (_that) {
case _JobDetailsResponse():
return $default(_that.jobId,_that.jobTitle,_that.companyName,_that.jobDescription,_that.location,_that.salary,_that.jobType,_that.applyUrl,_that.academicQualification,_that.experience,_that.languages,_that.workingHours,_that.workingDays,_that.applicationEmail,_that.jobDate,_that.phone,_that.source,_that.nationality,_that.gender,_that.matchPercentage);}
}
...
class _JobDetailsResponse implements JobDetailsResponse {
  const _JobDetailsResponse({@JsonKey(name: 'id') this.jobId, @JsonKey(name: 'job_title') this.jobTitle, @JsonKey(name: 'entity') this.companyName, @JsonKey(name: 'job_description') this.jobDescription, @JsonKey(name: 'vacancy_city') this.location, @JsonKey(name: 'salary') this.salary, @JsonKey(name: 'job_type') this.jobType, @JsonKey(name: 'apply_url') this.applyUrl, @JsonKey(name: 'academic_qualification') this.academicQualification, @JsonKey(name: 'experience') this.experience, @JsonKey(name: 'languages') this.languages, @JsonKey(name: 'working_hours') this.workingHours, @JsonKey(name: 'working_days') this.workingDays, @JsonKey(name: 'application_email') this.applicationEmail, @JsonKey(name: 'job_date') this.jobDate, @JsonKey(name: 'phone') this.phone, @JsonKey(name: 'source') this.source, @JsonKey(name: 'nationality') this.nationality, @JsonKey(name: 'gender') this.gender, @JsonKey(name: 'match_percentage') this.matchPercentage});
