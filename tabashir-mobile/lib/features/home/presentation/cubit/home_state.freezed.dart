...
mixin _$HomeState {
 ...
 Map<String, dynamic>? get clientProfile; List<CityJobCount> get cityJobCounts; List<Map<String, dynamic>> get latestJobsList; List<JobRecommendation> get matchedJobsList; List<JobRecommendation> get allMatchedJobsList; List<AppliedJob> get appliedJobsList;// Pagination for Matched Jobs
...
@override
int get hashCode => Object.hashAll([runtimeType,isLoading,error,errorMessage,const DeepCollectionEquality().hash(_jobs),matches,companiesViewed,matchDistribution,inReview,interview,offer,rejected,pending,unreadNotificationCount,user,const DeepCollectionEquality().hash(_recommendationsData),profileCompletionPercentage,applicationSuccessRate,avgMarketSalary,totalApplications,const DeepCollectionEquality().hash(_clientProfile),const DeepCollectionEquality().hash(_cityJobCounts),const DeepCollectionEquality().hash(_latestJobsList),const DeepCollectionEquality().hash(_matchedJobsList),const DeepCollectionEquality().hash(_allMatchedJobsList),const DeepCollectionEquality().hash(_appliedJobsList),matchedJobsPage,matchedJobsTotal,matchedJobsLimit,matchedJobsHasMore,isLoadingMoreMatched,appliedJobsPage,appliedJobsTotal,appliedJobsLimit,appliedJobsHasMore,isLoadingMoreApplied]);
