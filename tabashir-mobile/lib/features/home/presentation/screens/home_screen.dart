                ...
                if (initState.userProfile != null && state.user == null) {
                  ...
                  homeCubit.updateUserData(
                    UserData(
                      ...
                      emailVerified:
                          initState.userProfile!.user.emailVerified,
                ...
                return SafeArea(
                  child: Stack(
                    children: [
                      ...
                      RefreshIndicator(
                        onRefresh: () async {
                          print('[HOME_SCREEN] Pull to refresh triggered');
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: HomeAIMatchBannerWidget(
                                  ...
                                  jobTitle: _extractPrimaryJobTitle(state.jobs),
                                  locations: _extractUniqueLocations(state.jobs),
                                ),
                              ),
                              ...
                              Padding(
                                ...
                                child: const HomeJobCardsHorizontalListWidget(),
                              ),
                              SizedBox(height: AppTheme.spacingMd.h),
                              ...
                              Padding(
                                ...
                                child: HomeTrendingBannerWidget(
                                  trendingText: state.trendingData?['trendingText'] as String? ??
                                      'Flutter and Node.js roles are up 17%',
                                  growthPercentage: state.trendingData?['growthPercentage'] as int? ?? 17,
                                  topSkills: (state.trendingData?['topSkills'] as List<dynamic>? ?? [])
                                      .map((e) => e.toString())
                                      .toList(),
                                  seeOpportunitiesLink: state.trendingData?['seeOpportunitiesLink'] as String?,
                                ),
                              ),
                              SizedBox(height: AppTheme.spacingMd.h),
                              ...
                              Padding(
                                ...
                                child: HomeMarketInsightsWidget(
                                  trendingSkills: (state.marketInsights?['trendingSkills'] as List<dynamic>? ?? [])
                                      .map((e) => e as Map<String, dynamic>)
                                      .toList(),
                                  topLocations: (state.marketInsights?['topLocations'] as List<dynamic>? ?? [])
                                      .map((e) => e as Map<String, dynamic>)
                                      .toList(),
                                  totalJobs: state.marketInsights?['totalJobs'] as int? ?? 0,
                                  newJobsThisWeek: state.marketInsights?['newJobsThisWeek'] as int? ?? 0,
                                  averageApplicationsPerJob: (state.marketInsights?['averageApplicationsPerJob'] as num?)?.toDouble() ?? 0.0,
                                  totalApplications: state.marketInsights?['totalApplications'] as int? ?? 0,
                                ),
                              ),
                              SizedBox(height: AppTheme.spacingMd.h),
                              ...
                              Padding(
                                ...
                                child: HomeAnalyticsWidget(
                                  applicationStatusChart: (state.analyticsData?['applicationStatusChart'] as List<dynamic>? ?? [])
                                      .map((e) => e as Map<String, dynamic>)
                                      .toList(),
                                  matchScoreDistribution: (state.analyticsData?['matchScoreDistribution'] as List<dynamic>? ?? [])
                                      .map((e) => e as Map<String, dynamic>)
                                      .toList(),
                                  monthlyApplications: (state.analyticsData?['monthlyApplications'] as List<dynamic>? ?? [])
                                      .map((e) => e as Map<String, dynamic>)
                                      .toList(),
                                  skillsDemand: (state.analyticsData?['skillsDemand'] as List<dynamic>? ?? [])
                                      .map((e) => e as Map<String, dynamic>)
                                      .toList(),
                                ),
                              ),
                                ...
                                child: HomeActivityTimelineWidget(
                                  activities: [
                                    ActivityTimelineItem(
                                      ...
                                      subtitle: 'Applied to Steward position at Our restaurant',
                                      date: 'Today',
                                    ...
                                    ActivityTimelineItem(
                                      ...
                                      subtitle: 'Updated skills and experience',
                                      date: '2 days ago',
                                      icon: Iconsax.user,
