...
contact_run = contact_p.add_run("{% if header.location %}{{ header.location }} | {% endif %}{% if header.phone %}{{ header.phone }} | {% endif %}{% if email_text %}{{ email_text }}{% endif %}{% if linkedin_text %} | {{ linkedin_text }}{% endif %}{% if github_text %} | {{ github_text }}{% endif %}")
